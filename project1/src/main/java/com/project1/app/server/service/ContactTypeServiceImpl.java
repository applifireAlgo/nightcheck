...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Service for ContactType Master table Entity", complexity = Complexity.LOW)
...
public class ContactTypeServiceImpl extends ContactTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.project1.app.shared.contacts.ContactType> lstcontacttype = contactTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.project1.app.shared.contacts.ContactType lstcontacttype = contactTyperepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcontacttype);
        } catch (org.springframework.transaction.TransactionException e) {
