...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* com.project1.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.project1.app.server.repository..*(..))")
