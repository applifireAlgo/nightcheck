...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.contacts.CommunicationData other = (com.project1.app.shared.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
