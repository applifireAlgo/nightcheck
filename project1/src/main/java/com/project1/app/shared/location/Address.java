...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.location.Address other = (com.project1.app.shared.location.Address) obj;
            if (addressId == null) {
                return false;
