...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Region", complexity = Complexity.LOW)
...
public class Region implements Serializable, CommonEntityInterface, Comparator<Region> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.location.Region other = (com.project1.app.shared.location.Region) obj;
            if (regionId == null) {
                return false;
