...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppCustomer", complexity = Complexity.LOW)
...
public class AppCustomer implements Serializable, CommonEntityInterface, Comparator<AppCustomer> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.customers.AppCustomer other = (com.project1.app.shared.customers.AppCustomer) obj;
            if (appCustomerId == null) {
                return false;
