...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.contacts.CommunicationGroup other = (com.project1.app.shared.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
