...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.contacts.ContactType other = (com.project1.app.shared.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;
