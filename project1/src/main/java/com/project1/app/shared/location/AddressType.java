...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.location.AddressType other = (com.project1.app.shared.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;
