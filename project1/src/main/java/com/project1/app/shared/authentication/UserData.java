...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "pallavi.biroli@algorhythm.co.in", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.authentication.UserData other = (com.project1.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
