package com.project1.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.location.AddressExtended other = (com.project1.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
