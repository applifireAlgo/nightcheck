...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.contacts.Title other = (com.project1.app.shared.contacts.Title) obj;
            if (titleId == null) {
                return false;
