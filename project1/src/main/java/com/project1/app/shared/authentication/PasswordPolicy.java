...
@SourceCodeAuthorClass(createdBy = "pallavi.biroli@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "PasswordPolicy", complexity = Complexity.LOW)
...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    public boolean equals(Object obj) {
        try {
            com.project1.app.shared.authentication.PasswordPolicy other = (com.project1.app.shared.authentication.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
