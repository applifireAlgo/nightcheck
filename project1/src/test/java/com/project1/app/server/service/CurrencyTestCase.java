...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("u7xSzvELaAsHQS5U2bkewtBOihfVxrdR");
            country.setCapitalLatitude(10);
            country.setCapitalLongitude(11);
            country.setCountryCode1("9mH");
            country.setCountryCode2("4Qx");
            country.setCountryFlag("gZW2QNkYReFTuaYvxx7BYKZBb1dgvbldPatkwEnWee0dUl4sbg");
            country.setCountryName("k7KjXHknUiNgUBP8STSvAYUDXxLSnSKsMpdq0rVi2TqiwKGmpw");
            country.setCurrencyCode("0TX");
            country.setCurrencyName("esHGmbZo8ZXhbOhdlWqBp477AqeVJvg0Ch2VXyURs6ZjmiuBsv");
            country.setCurrencySymbol("JHvQG1Qpg45uzultmK634QchM0IFwgJS");
            country.setIsoNumeric(10);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("oPeTKfbMMAnEBPZaEnZzg0udgh6gvxchLGO5jYqp985zctuNrG");
            currency.setUnicodeDecimal("AJriOieWWRDQKagaYgEliGqKUTnrEXUCLjI7SKDoJy7eAQiqyH");
            currency.setUnicodeHex("qTDyWriFDdXkntoJbHcsl6O4u82FjoHLOTE2nGTkYm9EEsIgp1");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("BDuodQZUNFfBPsoY5uYRqNDwXlnBlPV6fewmLjtKA39DW34BIi");
            currency.setUnicodeDecimal("cc6E92D6J7Wa1BKsvaPtcHttLLXvrDjsFXNJAA74Z6wXNSb3ks");
            currency.setUnicodeHex("QSVfWN5rsA7TiLxka4J71Jc0akaThZnWdceWnPGPoQ2eqC4ryw");
