 ...
 * 
 */
Ext.define('Demop.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Demop.view.logalarm.LogAlarmMainViewController',
			'Demop.view.logalarm.tree.LogAlarmTreePanel',
			'Demop.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
