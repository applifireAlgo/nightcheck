 ...
 * 
 */
Ext.define('Demop.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Demop.view.logalarm.mainscreen.AddLogAlarmController',
			'Demop.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Demop.view.logalarm.mainscreen.AppAlarmPanel',
