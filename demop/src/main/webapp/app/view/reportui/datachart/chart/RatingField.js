...
Ext.define('Demop.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Demop.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Demop.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
