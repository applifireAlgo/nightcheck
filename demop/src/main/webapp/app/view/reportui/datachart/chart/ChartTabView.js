Ext.define('Demop.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Demop.view.reportui.datachart.chart.RatingField','Demop.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
