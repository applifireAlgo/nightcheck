 ...
 * 
 */
Ext.define('Demop.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Demop.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
