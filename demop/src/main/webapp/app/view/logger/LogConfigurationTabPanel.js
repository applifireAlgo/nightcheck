...
Ext
		.define(
				'Demop.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Demop.view.logger.tabs.details.DetailsTab',
							'Demop.view.logger.tabs.fileconnector.FileConnectorTab',
							'Demop.view.logger.tabs.dbconnector.DBConnectorTab',
							'Demop.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Demop.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Demop.view.logger.LogConfigurationTabPanelController',
