Ext.define('Demop.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Demop.view.usermanagement.admin.UserPasswordReset',
	            'Demop.view.usermanagement.admin.AddUserDetails',
	            'Demop.view.usermanagement.admin.ViewUser'],
