Ext.define('Demop.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Demop.view.usermanagement.enduser.UserProfileController', 'Demop.view.usermanagement.admin.AddUserDetailsViewModel', 'Demop.model.AddUserDataModel' ],
