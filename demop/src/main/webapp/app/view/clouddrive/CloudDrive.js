Ext.define("Demop.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Demop.view.clouddrive.CloudDriveController',
	             'Demop.view.clouddrive.documentview.DocumentsView',
	             'Demop.view.clouddrive.drivedetails.DriveDetails',
	             //'Demop.view.clouddrive.documentview.DocumentListView'
	             ],
