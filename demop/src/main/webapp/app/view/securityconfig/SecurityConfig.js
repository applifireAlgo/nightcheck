 ...
 * 
 */
Ext.define('Demop.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Demop.view.securityconfig.SecurityConfigController',
			'Demop.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
