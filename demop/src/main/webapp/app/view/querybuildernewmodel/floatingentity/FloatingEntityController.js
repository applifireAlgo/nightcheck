Ext.define('Demop.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Demop.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Demop.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Demop.view.querybuildernewmodel.floatingentity.EntitySprite',
