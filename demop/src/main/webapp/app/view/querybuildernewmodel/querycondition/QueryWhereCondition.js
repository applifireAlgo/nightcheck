Ext.define('Demop.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Demop.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
