Ext.define('Demop.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Demop.view.querybuildernewmodel.querycondition.QuerySelectController',
