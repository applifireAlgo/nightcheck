Ext.define('Demop.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Demop.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Demop.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Demop.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Demop.view.querybuildernewmodel.querydetail.QueryDetail');
