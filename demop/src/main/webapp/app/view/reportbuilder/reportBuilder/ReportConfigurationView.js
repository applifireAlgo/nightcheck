Ext.define('Demop.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Demop.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Demop.view.reportbuilder.gridconfig.GridConfigView',
	           'Demop.view.reportbuilder.properties.PropertiesPanelView',
	           'Demop.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
