Ext.define('Demop.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Demop.view.reportbuilder.reportlist.ReportListPanelView',
             'Demop.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Demop.view.reportbuilder.mainview.ReportMainController'
             ],
