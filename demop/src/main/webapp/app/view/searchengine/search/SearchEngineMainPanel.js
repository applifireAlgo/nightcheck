Ext.define('Demop.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Demop.view.searchengine.search.NorthPanel', 'Demop.view.searchengine.search.SearchResult','Demop.view.searchengine.search.SearchEngineMainPanelController'],
