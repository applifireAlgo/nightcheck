Ext
		.define(
				'Demop.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Demop.view.searchengine.search.SearchEngineMainPanelController','Demop.view.searchengine.search.PanelHeaderField' ,'Demop.view.searchengine.search.ReportGridView','Demop.view.searchengine.search.ReportChartView','Demop.view.searchengine.search.documentView','Demop.view.searchengine.search.DouMeanView','Demop.view.googlemaps.map.MapPanel'],
