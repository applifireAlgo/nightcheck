...
import newproj.app.server.repository.QuestionRepository;
...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("feKJufhIPgVG04M2UjbwZnPkn7bKGl7XgRoEdctJwd9xcs4Py7");
            question.setQuestionDetails("Uji");
            question.setQuestionIcon("QkBA8Xikxm1uyTE7UBpAhQ5FcCIC8MnjDZMmHH3MY1r9VXIfIT");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("MuVhveupd62WUFiE1yP8MNsYSQShzU50yIdQyTuZ5AZ8F6Ljkq");
            question.setQuestionDetails("t4i");
            question.setQuestionIcon("MnoYlRQs9r6agQ56B3QqzI7BF5iebD26qFu9RzMdlJ9aCFfwOr");
