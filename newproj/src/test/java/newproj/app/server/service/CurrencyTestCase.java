...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("iHKPHJXi9QKJ38LTpjxBGKvgShpcdeFI");
            country.setCapitalLatitude(7);
            country.setCapitalLongitude(0);
            country.setCountryCode1("xRP");
            country.setCountryCode2("f3a");
            country.setCountryFlag("e7MtQGtmRU4M3aPsgprgZ461lP3W7VmBspJtxYjTlsPpLfT3aP");
            country.setCountryName("F2s2OGZCpIwDyqXy0kNIr9kPM9vsu2Ozrc1pMnnJRRR9fSmCwF");
            country.setCurrencyCode("r28");
            country.setCurrencyName("yZSsjyy2TSRn3p3yyYdRyOnKI2cl7i5Iu4X0w30QMGXDFyN2vy");
            country.setCurrencySymbol("MXv4z3LntH9EsIbvw1reEV0AMvdIoh2T");
            country.setIsoNumeric(5);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("s7hYUsEJbWwEHdoFvyl3H46YudI4svAgk5vy1C5PYLQBg6b4pZ");
            currency.setUnicodeDecimal("ATEfgE7N9r9NjmYjwoScVgM34FGYOMcWxPwxdVLrtj3tTJ6njT");
            currency.setUnicodeHex("QhyKDMZW7iF2o9DWL4v3F3B9gapPDXRMLISPacOZXH1RSRnKsl");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("9elHFk4WFfvGWfYVk9OGyteTWhWRil2m1y7t2yTg6DOMJV4MiD");
            currency.setUnicodeDecimal("sXdmqgXcX5SYnkGqSVbzr5SY9KDpKWJCCVs9Xh7dNQwEUSHlaX");
            currency.setUnicodeHex("AwmgJew2UXhzaIcCud9AdAc4PyIjEvVXNcKf5Z9lURp9Xh8CAw");
