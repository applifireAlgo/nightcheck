Ext
		.define(
				'Newproj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newproj.view.searchengine.search.SearchEngineMainPanelController','Newproj.view.searchengine.search.PanelHeaderField' ,'Newproj.view.searchengine.search.ReportGridView','Newproj.view.searchengine.search.ReportChartView','Newproj.view.searchengine.search.documentView','Newproj.view.searchengine.search.DouMeanView','Newproj.view.googlemaps.map.MapPanel'],
