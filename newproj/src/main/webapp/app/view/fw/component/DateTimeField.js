 ...
 */
Ext.define('Newproj.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Newproj.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Newproj.view.fw.component.DateTimePicker(o);
    },
