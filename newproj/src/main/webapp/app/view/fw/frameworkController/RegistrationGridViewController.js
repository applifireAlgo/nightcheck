Ext.define('Newproj.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Newproj.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Newproj.view.console.ConsoleWindow');
