Ext.define("Newproj.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Newproj.view.clouddrive.CloudDriveController',
	             'Newproj.view.clouddrive.documentview.DocumentsView',
	             'Newproj.view.clouddrive.drivedetails.DriveDetails',
	             //'Newproj.view.clouddrive.documentview.DocumentListView'
	             ],
