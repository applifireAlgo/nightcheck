 ...
 * 
 */
Ext.define('Newproj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newproj.view.logalarm.mainscreen.AddLogAlarmController',
			'Newproj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newproj.view.logalarm.mainscreen.AppAlarmPanel',
