 ...
 * 
 */
Ext.define('Newproj.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Newproj.view.logalarm.LogAlarmMainViewController',
			'Newproj.view.logalarm.tree.LogAlarmTreePanel',
			'Newproj.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
