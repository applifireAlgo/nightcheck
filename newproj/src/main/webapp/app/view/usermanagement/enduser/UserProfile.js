Ext.define('Newproj.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Newproj.view.usermanagement.enduser.UserProfileController', 'Newproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Newproj.model.AddUserDataModel' ],
