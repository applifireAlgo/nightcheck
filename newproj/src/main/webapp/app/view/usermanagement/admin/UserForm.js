Ext.define('Newproj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Newproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Newproj.model.AddUserDataModel' ],
