Ext.define('Newproj.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newproj.view.usermanagement.admin.UserPasswordReset',
	            'Newproj.view.usermanagement.admin.AddUserDetails',
	            'Newproj.view.usermanagement.admin.ViewUser'],
