 ...
 * 
 */
Ext.define('Newproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
