...
Ext.define('Newproj.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Newproj.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Newproj.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
