Ext.define('Newproj.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Newproj.view.reportui.datachart.chart.RatingField','Newproj.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
