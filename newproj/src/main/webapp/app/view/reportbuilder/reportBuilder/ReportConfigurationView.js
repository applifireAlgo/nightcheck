Ext.define('Newproj.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Newproj.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Newproj.view.reportbuilder.gridconfig.GridConfigView',
	           'Newproj.view.reportbuilder.properties.PropertiesPanelView',
	           'Newproj.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
