Ext.define('Newproj.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Newproj.view.reportbuilder.reportlist.ReportListPanelView',
             'Newproj.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Newproj.view.reportbuilder.mainview.ReportMainController'
             ],
