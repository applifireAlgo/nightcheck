Ext.define('Newproj.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Newproj.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Newproj.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Newproj.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Newproj.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
