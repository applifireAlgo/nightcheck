Ext.define('Newproj.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Newproj.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Newproj.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Newproj.view.querybuildernewmodel.floatingentity.EntitySprite',
