Ext.define('Newproj.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Newproj.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Newproj.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Newproj.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Newproj.view.querybuildernewmodel.querydetail.QueryDetail');
