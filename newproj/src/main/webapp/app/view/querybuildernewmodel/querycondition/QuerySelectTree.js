Ext.define('Newproj.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Newproj.view.querybuildernewmodel.querycondition.QuerySelectController',
