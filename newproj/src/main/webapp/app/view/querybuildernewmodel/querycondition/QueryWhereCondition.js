Ext.define('Newproj.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Newproj.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
