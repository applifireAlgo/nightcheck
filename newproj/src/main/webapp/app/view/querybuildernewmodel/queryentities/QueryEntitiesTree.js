Ext.define('Newproj.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Newproj.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
