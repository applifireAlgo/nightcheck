Ext.define('Newproj.newproj.web.newproj.view.contacts.CoreContactsMain', {
     ...
     "requires": ["Newproj.newproj.shared.newproj.model.contacts.CoreContactsModel", "Newproj.newproj.web.newproj.controller.contacts.CoreContactsMainController", "Newproj.newproj.shared.newproj.model.contacts.TitleModel", "Newproj.newproj.shared.newproj.model.location.LanguageModel", "Newproj.newproj.shared.newproj.model.contacts.GenderModel", "Newproj.view.fw.component.Grids", "Newproj.newproj.shared.newproj.model.location.AddressTypeModel", "Newproj.newproj.shared.newproj.model.location.CountryModel", "Newproj.newproj.shared.newproj.model.location.StateModel", "Newproj.newproj.shared.newproj.model.location.CityModel", "Newproj.view.fw.component.Grids", "Newproj.newproj.shared.newproj.model.contacts.CommunicationGroupModel", "Newproj.newproj.shared.newproj.model.contacts.CommunicationTypeModel", "Newproj.newproj.shared.newproj.viewmodel.contacts.CoreContactsViewModel"],
     "communicationLog": [],
     "tabPosition": "bottom",
     "items": [{
          "title": "Data Browser",
                    ...
                    "items": [{
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "fieldId": "40E2D608-C9DD-4977-96C2-BD4CFD7C06FF",
                                   "minLength": "0",
                                   "maxLength": "64",
                                   "hidden": true,
                                   "value": "",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "75BC1A20-F203-454D-85B5-C3910542DB2E",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Newproj.newproj.shared.newproj.model.contacts.TitleModel"
                                   },
                                   "bindable": "titleId",
                                   "columnWidth": 0.5,
                                   "bind": "{titleId}"
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "B3EFBCC8-33C4-4B91-BC58-2E32AC67F52A",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "3A79E2A5-D029-4F4B-9169-8E7E782E72F8",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   "bindable": "middleName",
                                   "columnWidth": 0.5,
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "2F5CF124-3E87-48CF-AB15-ADBE49C33528",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "DCDFCA6C-65C0-4902-BEC5-84708B203A22",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Newproj.newproj.shared.newproj.model.location.LanguageModel"
                                   },
                                   ...
                                   "fieldId": "67888F57-D606-4201-B8C1-F4BABFF666CE",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   "typeAhead": true,
                                   "queryMode": "local",
                                   ...
                                   "fieldId": "4FFFC70B-F9EA-48C5-B4FD-12D0B506F461",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "6626830F-B880-4949-A434-9481F1012B20",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "5EBCA117-3986-49EA-9088-D66A80B4A448",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "DB170D2D-10C4-485A-9CB5-6A0382DC9C56",
                                   "errorMessage": "Please enter gender",
                                   "restURL": "Gender",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Newproj.newproj.shared.newproj.model.contacts.GenderModel"
                                   },
                                   "bindable": "genderId",
                                   "columnWidth": 0.5,
                                   "bind": "{genderId}"
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "DOB",
                                   "fieldId": "9F2EAD6F-EB0E-47CD-A638-9D9DAFAE585D",
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "Age",
                                   "fieldId": "FD74FAF8-0CAB-4261-AA07-0228BFD4E73D",
                                   "minValue": "0",
                                   "maxValue": "125",
                                   "bindable": "age",
                                   "columnWidth": 0.5,
                                   ...
                                   "fieldId": "070E1CCC-E2FB-432A-A592-05177FBE51DC",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "EA23B895-FCEA-44C1-A86F-4DD823FF66E6",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "B78E05D3-412E-44D1-B3DD-9AEA8294A8A1",
                                   "minLength": "0",
                                   "maxLength": "20",
                                   ...
                                   "fieldId": "4A2230C5-6B39-4296-B476-D1792B7DD1DB",
                                   "bindable": "versionId",
                                   "bind": "{versionId}",
                                   "hidden": true
                              }]
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "C859CDE4-1AA5-4273-9D3D-25D50AC8172A",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Newproj.newproj.shared.newproj.model.location.AddressTypeModel"
                                        },
                                        ...
                                        "fieldId": "8EBAF110-4810-480E-879B-18016C755F8C",
                                        "minLength": "0",
                                        "maxLength": "11",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address1",
                                        "fieldId": "420C0140-334B-45DB-A4EF-553F2FE92A52",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address2",
                                        "fieldId": "A564D4B1-04F4-464A-8F12-EACEEA2522F1",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address3",
                                        "fieldId": "A0AFE221-EB4E-4DB3-9484-69778BCD6E89",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "7460BE9A-E7B5-40F9-B3CC-47AE1EB758F1",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "85BE1523-2AC4-4FE0-AF95-28476BBA6679",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "458F1B70-57E7-4176-9C06-101D8C75EF43",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Newproj.newproj.shared.newproj.model.location.CityModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "682FBB95-9CF2-4671-AC5A-3CD91BED8C18",
                                        "minLength": "0",
                                        "maxLength": "6",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Latitude",
                                        "fieldId": "FA9E9399-251C-43D1-9D8B-2A100BAAA516",
                                        "minLength": "0",
                                        "maxLength": "64",
                                        ...
                                        "fieldId": "68DC9AE4-08AD-49C1-9546-59057C0E879A",
                                        "minLength": "0",
                                        "maxLength": "64",
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "4EF38DDA-654D-47B9-9506-BF567B0F02CE",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "9A19C24E-8A93-4376-9E5B-6DC6A8E2D0BA",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Newproj.newproj.shared.newproj.model.contacts.CommunicationTypeModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "24073451-A80B-4A26-BA93-E294F6D8E4DC",
                                        "minLength": "0",
