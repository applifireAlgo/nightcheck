...
folder are mapped to the application's root namespace, 'Newproj'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Newproj' in the same way
as `"Newproj/sass/src"`.
