package newproj.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* newproj.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* newproj.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* newproj.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* newproj.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* newproj.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* newproj.app.server.repository..*(..))")
