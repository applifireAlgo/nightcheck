Ext.define('Project21.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project21.view.usermanagement.admin.AddUserDetailsViewModel', 'Project21.model.AddUserDataModel' ],
