Ext.define('Project21.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Project21.view.usermanagement.admin.UserPasswordReset',
	            'Project21.view.usermanagement.admin.AddUserDetails',
	            'Project21.view.usermanagement.admin.ViewUser'],
