Ext.define('Project21.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Project21.view.resource.ResourcePanel',
			'Project21.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Project21.view.resource.DockedResourcePanel','Project21.view.fw.mainViewPanel.MainPanelController' ],
