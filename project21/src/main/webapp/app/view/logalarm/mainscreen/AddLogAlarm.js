 ...
 * 
 */
Ext.define('Project21.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project21.view.logalarm.mainscreen.AddLogAlarmController',
			'Project21.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project21.view.logalarm.mainscreen.AppAlarmPanel',
