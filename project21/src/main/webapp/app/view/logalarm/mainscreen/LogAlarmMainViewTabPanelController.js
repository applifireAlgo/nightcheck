 ...
 * 
 */
Ext.define('Project21.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Project21.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
