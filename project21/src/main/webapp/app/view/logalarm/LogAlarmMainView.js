 ...
 * 
 */
Ext.define('Project21.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Project21.view.logalarm.LogAlarmMainViewController',
			'Project21.view.logalarm.tree.LogAlarmTreePanel',
			'Project21.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
