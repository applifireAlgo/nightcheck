Ext.define('Project21.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Project21.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
