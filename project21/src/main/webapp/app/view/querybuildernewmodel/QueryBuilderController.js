Ext.define('Project21.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Project21.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Project21.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Project21.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Project21.view.querybuildernewmodel.querydetail.QueryDetail');
