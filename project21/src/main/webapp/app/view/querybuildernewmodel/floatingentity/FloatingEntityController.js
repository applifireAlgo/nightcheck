Ext.define('Project21.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Project21.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Project21.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Project21.view.querybuildernewmodel.floatingentity.EntitySprite',
