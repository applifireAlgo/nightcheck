 ...
 * 
 */
Ext.define('Project21.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project21.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
