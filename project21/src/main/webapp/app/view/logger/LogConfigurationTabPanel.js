...
Ext
		.define(
				'Project21.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project21.view.logger.tabs.details.DetailsTab',
							'Project21.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project21.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project21.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project21.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project21.view.logger.LogConfigurationTabPanelController',
