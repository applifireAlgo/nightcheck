Ext.define('Project21.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project21.view.reportui.datachart.chart.RatingField','Project21.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
