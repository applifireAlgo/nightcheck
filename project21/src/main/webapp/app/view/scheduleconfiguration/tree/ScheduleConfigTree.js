 ...
 * 
 */
Ext.define("Project21.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Project21.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
