Ext.define('Project21.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	//alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Project21.view.searchengine.search.NorthPanel', 'Project21.view.searchengine.search.SearchResult','Project21.view.searchengine.search.SearchEngineMainPanelController'],
