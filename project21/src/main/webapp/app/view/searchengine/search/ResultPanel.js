Ext
		.define(
				'Project21.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project21.view.searchengine.search.SearchEngineMainPanelController','Project21.view.searchengine.search.PanelHeaderField' ,'Project21.view.searchengine.search.ReportGridView','Project21.view.searchengine.search.ReportChartView','Project21.view.searchengine.search.documentView','Project21.view.searchengine.search.DouMeanView','Project21.view.googlemaps.map.MapPanel'],
