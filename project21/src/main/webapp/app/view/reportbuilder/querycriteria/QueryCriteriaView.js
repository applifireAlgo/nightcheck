Ext.define('Project21.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Project21.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Project21.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Project21.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Project21.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
