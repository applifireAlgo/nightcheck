Ext.define('Project21.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Project21.view.reportbuilder.reportlist.ReportListPanelView',
             'Project21.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Project21.view.reportbuilder.mainview.ReportMainController'
             ],
