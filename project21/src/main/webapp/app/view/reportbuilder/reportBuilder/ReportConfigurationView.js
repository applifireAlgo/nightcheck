Ext.define('Project21.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Project21.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Project21.view.reportbuilder.gridconfig.GridConfigView',
	           'Project21.view.reportbuilder.properties.PropertiesPanelView',
	           'Project21.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
