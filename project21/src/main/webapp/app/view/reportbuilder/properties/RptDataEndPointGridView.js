Ext.define('Project21.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Project21.view.reportbuilder.properties.RptDataEndPointGridController'],
