Ext.define('Project21.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Project21.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Project21.view.console.ConsoleWindow');
