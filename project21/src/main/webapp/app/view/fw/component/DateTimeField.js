 ...
 */
Ext.define('Project21.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project21.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project21.view.fw.component.DateTimePicker(o);
    },
