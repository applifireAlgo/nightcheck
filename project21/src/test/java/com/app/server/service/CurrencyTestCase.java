...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("kMpsjtJ4nnAjlnxylukWCTP5vxZNIaFM");
            country.setCapitalLatitude(5);
            country.setCapitalLongitude(8);
            country.setCountryCode1("MtC");
            country.setCountryCode2("9Z7");
            country.setCountryFlag("8rEtpkA7ErxmKdA71C9QzY9tCwlJLqM7Yy4sYO7zfmmnVEEMWI");
            country.setCountryName("VY3ZJgeTSMN7QyBvuSAuDy9hMOLa3r4c6SLAea5day0CBIbzas");
            country.setCurrencyCode("Cr3");
            country.setCurrencyName("yE0xdFm6QzwKGS28tIh4oR2GuIl9HY2lDzqaHX7nRvJzTPGg4f");
            country.setCurrencySymbol("GWrDRKbSWZdbifnlts7ZTZigrX0ZSlxs");
            country.setIsoNumeric(7);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("gfnfkqct9QB9VONyMRMq9ynqKGyTzHUnGNPQqOlFE0iJDCZ2gr");
            currency.setUnicodeDecimal("S4bazZOaZ0iMRW6f3b3dSygV6FlvR7MbyEv8dbBRMlBPOrU2mn");
            currency.setUnicodeHex("xJX6IzesGqa1Tmj0oQFWUTuZoOS2RcvpDUb3tzreDUUwR41zoB");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("pcbarBtfpNyu3gT7SEey8Cg3UQPKH3cCtidDyGefukFIPb9f8R");
            currency.setUnicodeDecimal("rYKkuti6o7srlw18Ls4NqxhjL6tnHAgNjdpnZq2bWHmKTcsrWY");
            currency.setUnicodeHex("dKX5eQRMH8FCohl5RSf5eTMH49iveo9OOeTnCK88ANhQELISFw");
